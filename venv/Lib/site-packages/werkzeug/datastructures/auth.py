...
class auth:
    """Represents the parts of an ``auth`` request header.

    :attr:`.Request.auth` returns an instance if the header is set.
    ...
    def __init__(
        ...
        self.type = auth_type
        """The auth scheme, like ``basic``, ``digest``, or ``bearer``."""
    ...
    def from_header(cls, value: str | None) -> te.Self | None:
        """Parse an ``auth`` header value and return an instance, or ``None``
    ...
    def to_header(self) -> str:
        """Produce an ``auth`` header value representing this data.
